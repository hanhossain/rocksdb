    ...
    block_based_table_type_info = {
        ...
        {"flush_block_policy_factory",
         OptionTypeInfo::AsCustomSharedPtr<FlushBlockPolicyFactory>(
             offsetof(struct BlockBasedTableOptions,
                      flush_block_policy_factory),
             rs::options_type::OptionVerificationType::ByName, rs::options_type::OptionTypeFlags::CompareNever)},
        ...
        {"checksum",
         {offsetof(struct BlockBasedTableOptions, checksum),
          rs::options_type::OptionType::ChecksumType, rs::options_type::OptionVerificationType::Normal,
          rs::options_type::OptionTypeFlags::None}},
        {"no_block_cache",
        ...
        {"block_cache_compressed",
         {0, rs::options_type::OptionType::Unknown, rs::options_type::OptionVerificationType::Deprecated,
          rs::options_type::OptionTypeFlags::None}},
