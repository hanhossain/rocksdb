...
static std::unordered_map<std::string, OptionTypeInfo> plain_table_type_info = {
    {"user_key_len",
     {offsetof(struct PlainTableOptions, user_key_len), rs::options_type::OptionType::UInt32T,
      rs::options_type::OptionVerificationType::Normal, OptionTypeFlags::kNone}},
    {"bloom_bits_per_key",
     {offsetof(struct PlainTableOptions, bloom_bits_per_key), rs::options_type::OptionType::Int,
      rs::options_type::OptionVerificationType::Normal, OptionTypeFlags::kNone}},
    {"hash_table_ratio",
     {offsetof(struct PlainTableOptions, hash_table_ratio), rs::options_type::OptionType::Double,
      rs::options_type::OptionVerificationType::Normal, OptionTypeFlags::kNone}},
    {"index_sparseness",
     {offsetof(struct PlainTableOptions, index_sparseness), rs::options_type::OptionType::SizeT,
      rs::options_type::OptionVerificationType::Normal, OptionTypeFlags::kNone}},
    {"huge_page_tlb_size",
    ...
    {"encoding_type",
     {offsetof(struct PlainTableOptions, encoding_type),
      rs::options_type::OptionType::EncodingType, rs::options_type::OptionVerificationType::Normal,
      OptionTypeFlags::kNone}},
    {"full_scan_mode",
     {offsetof(struct PlainTableOptions, full_scan_mode), rs::options_type::OptionType::Boolean,
      rs::options_type::OptionVerificationType::Normal, OptionTypeFlags::kNone}},
    {"store_index_in_file",
