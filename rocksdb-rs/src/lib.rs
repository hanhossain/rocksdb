...
use crate::universal_compaction::new_compaction_options_universal;
...
mod ffi {
    ...
    #[namespace = "rs::advanced_options"]
    extern "Rust" {
        #[cxx_name = "CompactionOptionsFIFO_new"]
    ...
    #[namespace = "rs::universal_compaction"]
    extern "Rust" {
        #[cxx_name = "CompactionOptionsUniversal_new"]
        fn new_compaction_options_universal() -> CompactionOptionsUniversal;
    }
}
