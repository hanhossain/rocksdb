...
TEST(BlobCountingIteratorTest, CountBlobs) {
  ...
  const std::vector<std::string> keys{
      test::KeyStr(user_key0, 1, rs::db::dbformat::ValueType::TypeBlobIndex),
      test::KeyStr(user_key1, 2, rs::db::dbformat::ValueType::TypeBlobIndex),
      test::KeyStr(user_key2, 3, rs::db::dbformat::ValueType::TypeValue)};
...
TEST(BlobCountingIteratorTest, CorruptBlobIndex) {
  const std::vector<std::string> keys{
      test::KeyStr("user_key", 1, rs::db::dbformat::ValueType::TypeBlobIndex)};
