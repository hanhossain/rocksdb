...
inline bool IsValueType(rs::db::dbformat::ValueType t) {
  return t <= rs::db::dbformat::ValueType::TypeMerge || rs::db::dbformat::ValueType::TypeSingleDeletion == t || rs::db::dbformat::ValueType::TypeBlobIndex == t ||
         rs::db::dbformat::ValueType::TypeDeletionWithTimestamp == t || rs::db::dbformat::ValueType::TypeWideColumnEntity == t;
}
...
inline bool IsExtendedValueType(rs::db::dbformat::ValueType t) {
  return IsValueType(t) || t == rs::db::dbformat::ValueType::TypeRangeDeletion || t == rs::db::dbformat::ValueType::TypeMaxValid;
}
...
struct ParsedInternalKey {
  ...
  ParsedInternalKey()
      : sequence(kMaxSequenceNumber),
        type(rs::db::dbformat::ValueType::TypeDeletion)  // Make code analyzer happy
  ...
  void clear() {
    user_key.clear();
    sequence = 0;
    type = rs::db::dbformat::ValueType::TypeDeletion;
  }
...
inline uint64_t PackSequenceAndType(uint64_t seq, rs::db::dbformat::ValueType t) {
  ...
  assert(IsExtendedValueType(t) || t == rs::db::dbformat::ValueType::TypeMaxValid);
...
inline Status ParseInternalKey(const Slice& internal_key,
  ...
  assert(result->type <= rs::db::dbformat::ValueType::MaxValue);
...
struct RangeTombstone {
  ...
  std::pair<InternalKey, Slice> Serialize() const {
    auto key = InternalKey(start_key_, seq_, rs::db::dbformat::ValueType::TypeRangeDeletion);
  ...
  InternalKey SerializeKey() const {
    return InternalKey(start_key_, seq_, rs::db::dbformat::ValueType::TypeRangeDeletion);
  }
  ...
  InternalKey SerializeEndKey() const {
    if (!ts_.empty()) {
      ...
      if (ts_.size() <= strlen(kTsMax)) {
        return InternalKey(end_key_, kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion,
