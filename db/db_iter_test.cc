...
class TestIterator : public InternalIterator {
 public:
  ...
  void AddPut(std::string argkey, std::string argvalue) {
    Add(argkey, rs::db::dbformat::ValueType::kTypeValue, argvalue);
  }

  void AddDeletion(std::string argkey) {
    Add(argkey, rs::db::dbformat::ValueType::kTypeDeletion, std::string());
  }

  void AddSingleDeletion(std::string argkey) {
    Add(argkey, rs::db::dbformat::ValueType::kTypeSingleDeletion, std::string());
  }

  void AddMerge(std::string argkey, std::string argvalue) {
    Add(argkey, rs::db::dbformat::ValueType::kTypeMerge, argvalue);
  }

  void Add(std::string argkey, rs::db::dbformat::ValueType type, std::string argvalue) {
...
class DBIterWithMergeIterTest : public testing::Test {
 public:
  DBIterWithMergeIterTest()
    ...
    internal_iter1_->Add("a", rs::db::dbformat::ValueType::kTypeValue, "1", 3u);
    internal_iter1_->Add("f", rs::db::dbformat::ValueType::kTypeValue, "2", 5u);
    internal_iter1_->Add("g", rs::db::dbformat::ValueType::kTypeValue, "3", 7u);
    internal_iter1_->Finish();

    internal_iter2_ = new TestIterator(BytewiseComparator());
    internal_iter2_->Add("a", rs::db::dbformat::ValueType::kTypeValue, "4", 6u);
    internal_iter2_->Add("b", rs::db::dbformat::ValueType::kTypeValue, "5", 1u);
    internal_iter2_->Add("c", rs::db::dbformat::ValueType::kTypeValue, "6", 2u);
    internal_iter2_->Add("d", rs::db::dbformat::ValueType::kTypeValue, "7", 3u);
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace1) {
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      ...
      [&](void* /*arg*/) { internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 12u); });
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace2) {
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "MergeIterator::Prev:BeforePrev", [&](void* /*arg*/) {
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 12u);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 11u);
      });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace3) {
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "MergeIterator::Prev:BeforePrev", [&](void* /*arg*/) {
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 16u, true);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 15u, true);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 14u, true);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 13u, true);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 12u, true);
        internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "7", 11u, true);
      });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace4) {
  ...
  internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "9", 4u);
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "MergeIterator::Prev:BeforePrev", [&](void* arg) {
        ...
        if (it->key().starts_with("z")) {
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 16u, true);
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 15u, true);
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 14u, true);
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 13u, true);
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 12u, true);
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 11u, true);
        }
      });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace7) {
  internal_iter1_->Add("u", rs::db::dbformat::ValueType::kTypeValue, "10", 4u);
  internal_iter1_->Add("v", rs::db::dbformat::ValueType::kTypeValue, "11", 4u);
  internal_iter1_->Add("w", rs::db::dbformat::ValueType::kTypeValue, "12", 4u);
  internal_iter2_->Add("z", rs::db::dbformat::ValueType::kTypeValue, "9", 4u);
...
TEST_F(DBIterWithMergeIterTest, InnerMergeIteratorDataRace8) {
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "MergeIterator::Prev:BeforePrev", [&](void* arg) {
        ...
        if (it->key().starts_with("z")) {
          internal_iter2_->Add("x", rs::db::dbformat::ValueType::kTypeValue, "7", 16u, true);
          internal_iter2_->Add("y", rs::db::dbformat::ValueType::kTypeValue, "7", 17u, true);
        }
      });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
