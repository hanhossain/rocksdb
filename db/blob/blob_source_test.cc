...
class BlobSourceTest : public DBTestBase {
 ...
 public:
  explicit BlobSourceTest()
    ...
    options_.lowest_used_cache_tier = rs::advanced_options::CacheTier::VolatileTier;
...
class BlobSecondaryCacheTest : public DBTestBase {
 ...
 public:
  explicit BlobSecondaryCacheTest()
    ...
    options_.lowest_used_cache_tier = rs::advanced_options::CacheTier::NonVolatileBlockTier;
