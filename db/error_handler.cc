...
std::map<std::tuple<BackgroundErrorReason, rs::status::Code, Status::SubCode, bool>,
         rs::status::Severity>
    ErrorSeverityMap = {
        // Errors during BG compaction
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         rs::status::Code::kIOError, Status::SubCode::kNoSpace,
                         true),
        ...
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         rs::status::Code::kIOError, Status::SubCode::kSpaceLimit,
                         true),
         rs::status::Severity::kHardError},
        {std::make_tuple(BackgroundErrorReason::kCompaction,
                         rs::status::Code::kIOError, Status::SubCode::kIOFenced,
                         true),
