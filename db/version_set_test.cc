 ...
 public:
  ...
  void Add(const char* smallest, const char* largest,
    ...
    FileMetaData* f = new FileMetaData(
        files_.size() + 1, 0, 0,
        InternalKey(smallest, smallest_seq, rs::db::dbformat::ValueType::TypeValue),
        InternalKey(largest, largest_seq, rs::db::dbformat::ValueType::TypeValue), smallest_seq,
...
class VersionStorageInfoTestBase : public testing::Test {
 public:
  ...
  InternalKey GetInternalKey(const char* ukey,
                             SequenceNumber smallest_seq = 100) {
    return InternalKey(ukey, smallest_seq, rs::db::dbformat::ValueType::TypeValue);
  }
  ...
  void Add(int level, uint32_t file_number, const InternalKey& smallest,
    ...
    FileMetaData* f = new FileMetaData(
        ...
        rs::advanced_options::Temperature::Unknown, oldest_blob_file_number,
...
TEST_F(VersionStorageInfoTest, GetOverlappingInputs) {
  ...
  Add(1, 1U, {"a", 0, rs::db::dbformat::ValueType::TypeValue},
      {"b", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion}, 1);
  Add(1, 2U, {"b", 0, rs::db::dbformat::ValueType::TypeValue}, {"c", 0, rs::db::dbformat::ValueType::TypeValue}, 1);
  // Two files that overlap at the same user key.
  Add(1, 3U, {"d", 0, rs::db::dbformat::ValueType::TypeValue}, {"e", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeValue}, 1);
  Add(1, 4U, {"e", 0, rs::db::dbformat::ValueType::TypeValue}, {"f", 0, rs::db::dbformat::ValueType::TypeValue}, 1);
  // Two files that do not overlap.
  Add(1, 5U, {"g", 0, rs::db::dbformat::ValueType::TypeValue}, {"h", 0, rs::db::dbformat::ValueType::TypeValue}, 1);
  Add(1, 6U, {"i", 0, rs::db::dbformat::ValueType::TypeValue}, {"j", 0, rs::db::dbformat::ValueType::TypeValue}, 1);

  UpdateVersionStorageInfo();

  ASSERT_EQ("1,2",
            GetOverlappingFiles(1, {"a", 0, rs::db::dbformat::ValueType::TypeValue}, {"b", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("1",
            GetOverlappingFiles(1, {"a", 0, rs::db::dbformat::ValueType::TypeValue},
                                {"b", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion}));
  ASSERT_EQ("2", GetOverlappingFiles(1, {"b", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeValue},
                                     {"c", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("3,4",
            GetOverlappingFiles(1, {"d", 0, rs::db::dbformat::ValueType::TypeValue}, {"e", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("3",
            GetOverlappingFiles(1, {"d", 0, rs::db::dbformat::ValueType::TypeValue},
                                {"e", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion}));
  ASSERT_EQ("3,4", GetOverlappingFiles(1, {"e", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeValue},
                                       {"f", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("3,4",
            GetOverlappingFiles(1, {"e", 0, rs::db::dbformat::ValueType::TypeValue}, {"f", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("5",
            GetOverlappingFiles(1, {"g", 0, rs::db::dbformat::ValueType::TypeValue}, {"h", 0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("6",
            GetOverlappingFiles(1, {"i", 0, rs::db::dbformat::ValueType::TypeValue}, {"j", 0, rs::db::dbformat::ValueType::TypeValue}));
}
...
TEST_F(VersionStorageInfoTimestampTest, GetOverlappingInputs) {
  Add(/*level=*/1, /*file_number=*/1, /*smallest=*/
      {PackUserKeyAndTimestamp("a", /*ts=*/9), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*largest=*/
      {PackUserKeyAndTimestamp("a", /*ts=*/8), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*file_size=*/100);
  Add(/*level=*/1, /*file_number=*/2, /*smallest=*/
      {PackUserKeyAndTimestamp("a", /*ts=*/5), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*largest=*/
      {PackUserKeyAndTimestamp("b", /*ts=*/10), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*file_size=*/100);
  Add(/*level=*/1, /*file_number=*/3, /*smallest=*/
      {PackUserKeyAndTimestamp("c", /*ts=*/12), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*largest=*/
      {PackUserKeyAndTimestamp("d", /*ts=*/1), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
      /*file_size=*/100);
  ...
  ASSERT_EQ(
      ...
      GetOverlappingFiles(
          /*level=*/1,
          {PackUserKeyAndTimestamp("a", /*ts=*/12), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
          {PackUserKeyAndTimestamp("a", /*ts=*/11), /*s=*/0, rs::db::dbformat::ValueType::TypeValue}));
  ASSERT_EQ("3",
            GetOverlappingFiles(
                /*level=*/1,
                {PackUserKeyAndTimestamp("c", /*ts=*/15), /*s=*/0, rs::db::dbformat::ValueType::TypeValue},
                {PackUserKeyAndTimestamp("c", /*ts=*/2), /*s=*/0, rs::db::dbformat::ValueType::TypeValue}));
}
...
class FindLevelFileTest : public testing::Test {
 public:
  ...
  void Add(const char* smallest, const char* largest,
           SequenceNumber smallest_seq = 100,
           SequenceNumber largest_seq = 100) {
    InternalKey smallest_key = InternalKey(smallest, smallest_seq, rs::db::dbformat::ValueType::TypeValue);
    InternalKey largest_key = InternalKey(largest, largest_seq, rs::db::dbformat::ValueType::TypeValue);
  ...
  int Find(const char* key) {
    InternalKey target(key, 100, rs::db::dbformat::ValueType::TypeValue);
  ...
  void CreateDummyTableFiles(const std::vector<SstInfo>& file_infos,
    ...
    for (const auto& info : file_infos) {
      ...
      std::unique_ptr<TableBuilder> builder(table_factory_->NewTableBuilder(
          ...
          fwriter.get()));
      InternalKey ikey(info.key, 0, rs::db::dbformat::ValueType::TypeValue);
      ...
      file_metas->emplace_back(file_num, /*file_path_id=*/0, file_size, ikey,
                               ikey, 0, 0, false, rs::advanced_options::Temperature::Unknown, 0, 0,
...
TEST_F(VersionSetTestMissingFiles, ManifestFarBehindSst) {
  ...
  for (uint64_t file_num = 10; file_num < 15; ++file_num) {
    ...
    InternalKey smallest_ikey(smallest_ukey, 1, rs::db::dbformat::ValueType::TypeValue);
    InternalKey largest_ikey(largest_ukey, 1, rs::db::dbformat::ValueType::TypeValue);
