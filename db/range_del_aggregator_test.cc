...
ParsedInternalKey UncutEndpoint(const Slice& s) {
  return ParsedInternalKey(s, kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion);
}
...
TEST_F(RangeDelAggregatorTest, UntruncatedIter) {
  ...
  VerifyIterator(
      &iter, bytewise_icmp,
      {{InternalValue("a", 10, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("e"), 10},
       {InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("n"), 4}});

  VerifySeek(
      &iter, bytewise_icmp,
      {{"d", InternalValue("a", 10, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("e"),
        10},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("n"), 4},
       {"n", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */},
       {"", InternalValue("a", 10, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("e"),
        10}});
  ...
  VerifySeekForPrev(
      ...
      {{"d", InternalValue("a", 10, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("e"),
        10},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"n", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("n"), 4},
       {"", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */}});
}
...
TEST_F(RangeDelAggregatorTest, UntruncatedIterWithSnapshot) {
  ...
  VerifySeek(
      &iter, bytewise_icmp,
      {{"d", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("n"), 4},
       {"n", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */},
  ...
  VerifySeekForPrev(
      &iter, bytewise_icmp,
      {{"d", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"n", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("n"), 4},
...
TEST_F(RangeDelAggregatorTest, TruncatedIterPartiallyCutTombstones) {
  ...
  InternalKey smallest("d", 7, rs::db::dbformat::ValueType::TypeValue);
  InternalKey largest("m", 9, rs::db::dbformat::ValueType::TypeValue);
  TruncatedRangeDelIterator iter(std::move(input_iter), &bytewise_icmp,
                                 &smallest, &largest);

  VerifyIterator(
      &iter, bytewise_icmp,
      {{InternalValue("d", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("e"), 10},
       {InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion),
        InternalValue("m", 8, rs::db::dbformat::ValueType::TypeMaxValid), 4}});

  VerifySeek(
      &iter, bytewise_icmp,
      {{"d", InternalValue("d", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("e"), 10},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion),
        InternalValue("m", 8, rs::db::dbformat::ValueType::TypeMaxValid), 4, false /* invalid */},
       {"n", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */},
       {"", InternalValue("d", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("e"), 10}});
  ...
  VerifySeekForPrev(
      ...
      {{"d", InternalValue("d", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("e"), 10},
       {"e", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"ia", InternalValue("e", 8, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint("g"), 8},
       {"n", InternalValue("j", 4, rs::db::dbformat::ValueType::TypeRangeDeletion),
        InternalValue("m", 8, rs::db::dbformat::ValueType::TypeMaxValid), 4, false /* invalid */},
       {"", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */}});
}
...
TEST_F(RangeDelAggregatorTest, TruncatedIterFullyCutTombstones) {
  ...
  InternalKey smallest("f", 7, rs::db::dbformat::ValueType::TypeValue);
  InternalKey largest("i", 9, rs::db::dbformat::ValueType::TypeValue);
  TruncatedRangeDelIterator iter(std::move(input_iter), &bytewise_icmp,
                                 &smallest, &largest);

  VerifyIterator(
      &iter, bytewise_icmp,
      {{InternalValue("f", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("g"), 8}});

  VerifySeek(
      &iter, bytewise_icmp,
      {{"d", InternalValue("f", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("g"), 8},
       {"f", InternalValue("f", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("g"), 8},
       {"j", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */}});
  ...
  VerifySeekForPrev(
      ...
      {{"d", InternalValue("", 0, rs::db::dbformat::ValueType::TypeRangeDeletion), UncutEndpoint(""), 0,
        true /* invalid */},
       {"f", InternalValue("f", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("g"), 8},
       {"j", InternalValue("f", 7, rs::db::dbformat::ValueType::TypeMaxValid), UncutEndpoint("g"), 8}});
}
...
TEST_F(RangeDelAggregatorTest, MultipleTruncatedItersInAggregator) {
  ...
  std::vector<std::pair<InternalKey, InternalKey>> iter_bounds = {
      {InternalKey("a", 4, rs::db::dbformat::ValueType::TypeValue),
       InternalKey("m", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion)},
      {InternalKey("m", 20, rs::db::dbformat::ValueType::TypeValue),
       InternalKey("x", kMaxSequenceNumber, rs::db::dbformat::ValueType::TypeRangeDeletion)},
      {InternalKey("x", 5, rs::db::dbformat::ValueType::TypeValue), InternalKey("zz", 30, rs::db::dbformat::ValueType::TypeValue)}};
...
TEST_F(RangeDelAggregatorTest, CompactionAggregatorEmptyIteratorRight) {
  ...
  InternalKey start_buf("p", 0, rs::db::dbformat::ValueType::TypeRangeDeletion);
  InternalKey end_buf("q", 0, rs::db::dbformat::ValueType::TypeRangeDeletion);
...
TEST_F(RangeDelAggregatorTest, CompactionAggregatorBoundedIterator) {
  ...
  InternalKey start_buf("bb", 0, rs::db::dbformat::ValueType::TypeRangeDeletion);
  InternalKey end_buf("e", 9, rs::db::dbformat::ValueType::TypeRangeDeletion);
  Slice start = start_buf.Encode();
  Slice end = end_buf.Encode();
  auto range_del_compaction_iter = range_del_agg.NewIterator(&start, &end);
  VerifyFragmentedRangeDels(range_del_compaction_iter.get(),
...
TEST_F(RangeDelAggregatorTest,
  ...
  InternalKey start_buf("bb", 0, rs::db::dbformat::ValueType::TypeRangeDeletion);
  InternalKey end_buf("e", 0, rs::db::dbformat::ValueType::TypeRangeDeletion);
  Slice start = start_buf.Encode();
  Slice end = end_buf.Encode();
  auto range_del_compaction_iter = range_del_agg.NewIterator(&start, &end);
