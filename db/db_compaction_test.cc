...
TEST_F(DBCompactionTest, RoundRobinTtlCompactionUnsortedTime) {
  ...
  const InternalKey split_cursor = InternalKey(Key(600), 100000, rs::db::dbformat::ValueType::TypeValue);
...
TEST_F(DBCompactionTest, RoundRobinCutOutputAtCompactCursor) {
  ...
  const InternalKey split_cursor = InternalKey(Key(600), 100, rs::db::dbformat::ValueType::TypeValue);
