...
static std::unordered_map<std::string, OptionTypeInfo> cfd_type_info = {
    {"name",
     {offsetof(struct ColumnFamilyDescriptor, name), rs::options_type::OptionType::EncodedString,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
    {"options",
     {offsetof(struct ColumnFamilyDescriptor, options),
      rs::options_type::OptionType::Configurable, OptionVerificationType::kNormal,
...
static std::unordered_map<std::string, OptionTypeInfo> cs_input_type_info = {
    ...
    {"snapshots", OptionTypeInfo::Vector<uint64_t>(
                      ...
                      OptionVerificationType::kNormal, OptionTypeFlags::kNone,
                      {0, rs::options_type::OptionType::UInt64T})},
    {"input_files", OptionTypeInfo::Vector<std::string>(
                        offsetof(struct CompactionServiceInput, input_files),
                        OptionVerificationType::kNormal, OptionTypeFlags::kNone,
                        {0, rs::options_type::OptionType::EncodedString})},
    {"output_level",
     {offsetof(struct CompactionServiceInput, output_level), rs::options_type::OptionType::Int,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
    {"db_id",
     {offsetof(struct CompactionServiceInput, db_id),
      rs::options_type::OptionType::EncodedString}},
    {"has_begin",
     {offsetof(struct CompactionServiceInput, has_begin), rs::options_type::OptionType::Boolean,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
    {"begin",
     {offsetof(struct CompactionServiceInput, begin),
      rs::options_type::OptionType::EncodedString, OptionVerificationType::kNormal,
      OptionTypeFlags::kNone}},
    {"has_end",
     {offsetof(struct CompactionServiceInput, has_end), rs::options_type::OptionType::Boolean,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
    {"end",
     {offsetof(struct CompactionServiceInput, end), rs::options_type::OptionType::EncodedString,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
};
    ...
    compaction_job_stats_type_info = {
        {"elapsed_micros",
         {offsetof(struct CompactionJobStats, elapsed_micros),
          ...
          OptionTypeFlags::kNone}},
        {"cpu_micros",
         {offsetof(struct CompactionJobStats, cpu_micros), rs::options_type::OptionType::UInt64T,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"num_input_records",
...
static std::unordered_map<std::string, OptionTypeInfo> cs_result_type_info = {
    {"status",
     {offsetof(struct CompactionServiceResult, status),
      rs::options_type::OptionType::Customizable, OptionVerificationType::kNormal,
      OptionTypeFlags::kNone,
      [](const ConfigOptions& opts, const std::string& /*name*/,
         const std::string& value, void* addr) {
    ...
    {"output_files",
     OptionTypeInfo::Vector<CompactionServiceOutputFile>(
         ...
         OptionTypeInfo::Struct("output_files", &cs_output_file_type_info, 0,
                                ...
                                OptionTypeFlags::kNone))},
    {"output_level",
     {offsetof(struct CompactionServiceResult, output_level), rs::options_type::OptionType::Int,
      OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
    {"output_path",
