...
static std::unordered_map<std::string, OptionTypeInfo> cfd_type_info = {
    ...
    {"options",
     {offsetof(struct ColumnFamilyDescriptor, options),
      rs::options_type::OptionType::Configurable, rs::options_type::OptionVerificationType::Normal,
...
static std::unordered_map<std::string, OptionTypeInfo> cs_input_type_info = {
    ...
    {"begin",
     {offsetof(struct CompactionServiceInput, begin),
      rs::options_type::OptionType::EncodedString, rs::options_type::OptionVerificationType::Normal,
      rs::options_type::OptionTypeFlags::None}},
    {"has_end",
...
struct StatusSerializationAdapter {
  ...
  Status GetStatus() const {
    return Status{static_cast<rs::status::Code>(code),
                  static_cast<rs::status::SubCode>(subcode),
...
static std::unordered_map<std::string, OptionTypeInfo> cs_result_type_info = {
    {"status",
     {offsetof(struct CompactionServiceResult, status),
      rs::options_type::OptionType::Customizable, rs::options_type::OptionVerificationType::Normal,
      rs::options_type::OptionTypeFlags::None,
      [](const ConfigOptions& opts, const std::string& /*name*/,
         const std::string& value, void* addr) {
