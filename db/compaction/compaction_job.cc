...
void CompactionJob::GenSubcompactionBoundaries() {
  ...
  if (c->max_subcompactions() <= 1 &&
      !(c->immutable_options()->compaction_pri == rs::advanced_options::CompactionPri::RoundRobin &&
        c->immutable_options()->compaction_style == rs::advanced_options::CompactionStyle::Level)) {
    return;
  }
  ...
  if (c->immutable_options()->compaction_pri == rs::advanced_options::CompactionPri::RoundRobin &&
      c->immutable_options()->compaction_style == rs::advanced_options::CompactionStyle::Level) {
...
void CompactionJob::ProcessKeyValueCompaction(SubcompactionState* sub_compact) {
      ...
      (mutable_cf_options->enable_blob_files &&
       sub_compact->compaction->output_level() >=
          ...
          ? new BlobFileBuilder(
                ...
                rs::types::BlobFileCreationReason::Compaction, &blob_file_paths,
  ...
  if ((status.ok() || status.IsColumnFamilyDropped()) &&
    ...
    status = Status::Incomplete(rs::status::SubCode::kManualCompactionPaused);
  }
  if (status.ok()) {
    status = input->status();
  }
...
Status CompactionJob::FinishCompactionOutputFile(
  ...
  EventHelpers::LogAndNotifyTableFileCreationFinished(
      ...
      rs::types::TableFileCreationReason::Compaction, status_for_listener, file_checksum,
...
Status CompactionJob::InstallCompactionResults(
  ...
  if ((compaction->compaction_reason() ==
      ...
      compaction->immutable_options()->compaction_pri == rs::advanced_options::CompactionPri::RoundRobin) {
...
Status CompactionJob::OpenCompactionOutputFile(SubcompactionState* sub_compact,
  ...
  EventHelpers::NotifyTableFileCreationStarted(
      ...
      rs::types::TableFileCreationReason::Compaction);
  ...
  if (!s.ok()) {
    ...
    EventHelpers::LogAndNotifyTableFileCreationFinished(
        ...
        TableProperties(), rs::types::TableFileCreationReason::Compaction, s,
  ...
  TableBuilderOptions tboptions(
      *cfd->ioptions(), *(sub_compact->compaction->mutable_cf_options()),
      ...
      bottommost_level_, rs::types::TableFileCreationReason::Compaction,
