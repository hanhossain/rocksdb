  ...
  void Add(int level, uint32_t file_number, const char* smallest,
    ...
    InternalKey smallest_ikey = InternalKey(
        smallest_key_buf ? Slice(smallest_key_buf,
                         ...
                         : smallest,
        smallest_seq, rs::db::dbformat::ValueType::TypeValue);
    InternalKey largest_ikey = InternalKey(
        largest_key_buf
            ? Slice(largest_key_buf, ucmp_->timestamp_size() + strlen(largest))
            : largest,
        largest_seq, rs::db::dbformat::ValueType::TypeValue);
...
TEST_F(CompactionPickerTest, CompactionPriRoundRobin) {
  std::vector<InternalKey> test_cursors = {InternalKey("249", 100, rs::db::dbformat::ValueType::TypeValue),
                                           InternalKey("600", 100, rs::db::dbformat::ValueType::TypeValue),
                                           InternalKey()};
...
TEST_F(CompactionPickerTest, CompactionPriMultipleFilesRoundRobin1) {
  ...
  vstorage_->AddCursorForOneLevel(2, InternalKey("199", 100, rs::db::dbformat::ValueType::TypeValue));
...
TEST_F(CompactionPickerTest, CompactionPriMultipleFilesRoundRobin2) {
  ...
  vstorage_->AddCursorForOneLevel(2, InternalKey("1000", 100, rs::db::dbformat::ValueType::TypeValue));
...
TEST_F(CompactionPickerTest, CompactionPriMultipleFilesRoundRobin3) {
  ...
  vstorage_->AddCursorForOneLevel(2, InternalKey("700", 100, rs::db::dbformat::ValueType::TypeValue));
  Add(2, 6U, "150", "199", 500U);
  Add(2, 7U, "200", "249", 500U);
  Add(2, 8U, "300", "600", 500U);
  Add(2, 9U, "700", "800", 500U);
