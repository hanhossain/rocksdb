...
bool CompactionPicker::FilesRangeOverlapWithCompaction(
  ...
  if (penultimate_level != Compaction::kInvalidLevel) {
    if (ioptions_.compaction_style == rs::advanced_options::CompactionStyle::Universal) {
...
Compaction* CompactionPicker::CompactFiles(
  ...
  auto c = new Compaction(
      ...
      rs::advanced_options::Temperature::Unknown, compact_options.max_subcompactions,
      /* grandparents */ {}, true);
...
Compaction* CompactionPicker::CompactRange(
  ...
  assert(ioptions_.compaction_style != rs::advanced_options::CompactionStyle::FIFO);

  if (input_level == ColumnFamilyData::kCompactAllLevels) {
    assert(ioptions_.compaction_style == rs::advanced_options::CompactionStyle::Universal);
    ...
    *compaction_end = nullptr;
    ...
    Compaction* c = new Compaction(
        ...
        GetCompressionOptions(mutable_cf_options, vstorage, output_level),
        rs::advanced_options::Temperature::Unknown, compact_range_options.max_subcompactions,
...
void CompactionPicker::RegisterCompaction(Compaction* c) {
  ...
  assert(ioptions_.compaction_style != rs::advanced_options::CompactionStyle::Level ||
         c->output_level() == 0 ||
