...
static std::unordered_map<std::string, OptionTypeInfo>
    db_immutable_options_type_info = {
        ...
        {"experimental_mempurge_policy",
         {0, rs::options_type::OptionType::String, rs::options_type::OptionVerificationType::Deprecated,
          rs::options_type::OptionTypeFlags::None}},
        ...
        {"rate_limiter",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rs::options_type::OptionType::Unknown, rs::options_type::OptionVerificationType::Deprecated,
          rs::options_type::OptionTypeFlags::DontSerialize | rs::options_type::OptionTypeFlags::CompareNever}},
        // The following properties were handled as special cases in ParseOption
        // This means that the properties could be read from the options file
        // but never written to the file or compared to each other.
        {"rate_limiter_bytes_per_sec",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rs::options_type::OptionType::Unknown, rs::options_type::OptionVerificationType::Normal,
          (rs::options_type::OptionTypeFlags::DontSerialize | rs::options_type::OptionTypeFlags::CompareNever),
        ...
        {"lowest_used_cache_tier",
         OptionTypeInfo::Enum<rs::advanced_options::CacheTier>(
             ...
             &cache_tier_string_map, rs::options_type::OptionTypeFlags::None)},
