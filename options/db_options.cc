    ...
    db_mutable_options_type_info = {
        ...
        {"stats_history_buffer_size",
         {offsetof(struct MutableDBOptions, stats_history_buffer_size),
          ...
          OptionTypeFlags::kMutable}},
        {"max_open_files",
         {offsetof(struct MutableDBOptions, max_open_files), rs::options_type::OptionType::Int,
    ...
    db_immutable_options_type_info = {
        ...
        {"use_direct_io_for_flush_and_compaction",
         {offsetof(struct ImmutableDBOptions,
          ...
          OptionTypeFlags::kNone}},
        {"allow_2pc",
         {offsetof(struct ImmutableDBOptions, allow_2pc), rs::options_type::OptionType::Boolean,
        ...
        {"experimental_mempurge_policy",
         {0, rs::options_type::OptionType::String, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kNone}},
        ...
        {"use_adaptive_mutex",
         {offsetof(struct ImmutableDBOptions, use_adaptive_mutex),
          ...
          OptionTypeFlags::kNone}},
        {"use_fsync",
         {offsetof(struct ImmutableDBOptions, use_fsync), rs::options_type::OptionType::Boolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        ...
        {"max_log_file_size",
         {offsetof(struct ImmutableDBOptions, max_log_file_size),
          ...
          OptionTypeFlags::kNone}},
        {"db_log_dir",
         {offsetof(struct ImmutableDBOptions, db_log_dir), rs::options_type::OptionType::String,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"wal_dir",
         {offsetof(struct ImmutableDBOptions, wal_dir), rs::options_type::OptionType::String,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"WAL_size_limit_MB",
        ...
        {"bgerror_resume_retry_interval",
         {offsetof(struct ImmutableDBOptions, bgerror_resume_retry_interval),
          ...
          OptionTypeFlags::kNone}},
        {"db_host_id",
         {offsetof(struct ImmutableDBOptions, db_host_id), rs::options_type::OptionType::String,
        ...
        {"rate_limiter",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rs::options_type::OptionType::Unknown, OptionVerificationType::kDeprecated,
        ...
        {"rate_limiter_bytes_per_sec",
         {offsetof(struct ImmutableDBOptions, rate_limiter),
          rs::options_type::OptionType::Unknown, OptionVerificationType::kNormal,
          (OptionTypeFlags::kDontSerialize | OptionTypeFlags::kCompareNever),
        ...
        {"env",  //**TODO: Should this be kCustomizable?
         OptionTypeInfo(
             offsetof(struct ImmutableDBOptions, env), rs::options_type::OptionType::Unknown,
        ...
        {"listeners",
         {offsetof(struct ImmutableDBOptions, listeners), rs::options_type::OptionType::Vector,
