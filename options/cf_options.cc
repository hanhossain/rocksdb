    ...
    compression_options_type_info = {
        ...
        {"max_compressed_bytes_per_kb",
         {offsetof(struct CompressionOptions, max_compressed_bytes_per_kb),
          rs::options_type::OptionType::Int, OptionVerificationType::kNormal,
        ...
        {"max_dict_buffer_bytes",
         {offsetof(struct CompressionOptions, max_dict_buffer_bytes),
          rs::options_type::OptionType::UInt64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
    ...
    fifo_compaction_options_type_info = {
        ...
        {"age_for_warm",
         {offsetof(struct rs::advanced_options::CompactionOptionsFIFO, age_for_warm),
          ...
          OptionTypeFlags::kMutable}},
        {"ttl",
         {0, rs::options_type::OptionType::UInt64T, OptionVerificationType::kDeprecated,
    ...
    universal_compaction_options_type_info = {
        {"size_ratio",
         {offsetof(class CompactionOptionsUniversal, size_ratio),
          rs::options_type::OptionType::UInt, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"min_merge_width",
        ...
        {"stop_style",
         {offsetof(class CompactionOptionsUniversal, stop_style),
          rs::options_type::OptionType::CompactionStopStyle, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"incremental",
    ...
    cf_mutable_options_type_info = {
        ...
        {"disable_auto_compactions",
         {offsetof(struct MutableCFOptions, disable_auto_compactions),
          ...
          OptionTypeFlags::kMutable}},
        {"filter_deletes",
         {0, rs::options_type::OptionType::Boolean, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"hard_pending_compaction_bytes_limit",
         {offsetof(struct MutableCFOptions,
          ...
          OptionTypeFlags::kMutable}},
        {"hard_rate_limit",
         {0, rs::options_type::OptionType::Double, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"soft_rate_limit",
         {0, rs::options_type::OptionType::Double, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"expanded_compaction_factor",
         {0, rs::options_type::OptionType::Int, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        ...
        {"memtable_prefix_bloom_huge_page_tlb_size",
         {0, rs::options_type::OptionType::SizeT, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"write_buffer_size",
        ...
        {"memtable_prefix_bloom_bits",
         {0, rs::options_type::OptionType::UInt32T, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"memtable_prefix_bloom_size_ratio",
         {offsetof(struct MutableCFOptions, memtable_prefix_bloom_size_ratio),
          rs::options_type::OptionType::Double, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        ...
        {"compression",
         {offsetof(struct MutableCFOptions, compression),
          rs::options_type::OptionType::CompressionType, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"prefix_extractor",
        ...
        {"bottommost_temperature",
         {0, rs::options_type::OptionType::Temperature, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kMutable}},
        {"last_level_temperature",
         {offsetof(struct MutableCFOptions, last_level_temperature),
          rs::options_type::OptionType::Temperature, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {"enable_blob_files",
        ...
        {"block_protection_bytes_per_key",
         {offsetof(struct MutableCFOptions, block_protection_bytes_per_key),
          rs::options_type::OptionType::UInt8T, OptionVerificationType::kNormal,
          OptionTypeFlags::kMutable}},
        {kOptNameCompOpts,
         OptionTypeInfo::Struct(
...
static std::unordered_map<std::string, OptionTypeInfo>
    cf_immutable_options_type_info = {
        ...
        {"max_write_buffer_size_to_maintain",
         {offsetof(struct ImmutableCFOptions,
                   max_write_buffer_size_to_maintain),
          rs::options_type::OptionType::Int64T, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        ...
        {"rate_limit_delay_max_milliseconds",
         {0, rs::options_type::OptionType::UInt, OptionVerificationType::kDeprecated,
          OptionTypeFlags::kNone}},
        {"comparator",
        ...
        {"memtable_factory",
         {offsetof(struct ImmutableCFOptions, memtable_factory),
          rs::options_type::OptionType::Customizable, OptionVerificationType::kByName,
        ...
        {"memtable",
         {offsetof(struct ImmutableCFOptions, memtable_factory),
          rs::options_type::OptionType::Customizable, OptionVerificationType::kAlias,
          OptionTypeFlags::kShared,
          [](const ConfigOptions& opts, const std::string&,
             const std::string& value, void* addr) {
            std::unique_ptr<MemTableRepFactory> factory;
        ...
        {"compaction_style",
         {offsetof(struct ImmutableCFOptions, compaction_style),
          rs::options_type::OptionType::CompactionStyle, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
        {"compaction_pri",
         {offsetof(struct ImmutableCFOptions, compaction_pri),
          rs::options_type::OptionType::CompactionPri, OptionVerificationType::kNormal,
          OptionTypeFlags::kNone}},
