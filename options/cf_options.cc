    ...
    cf_immutable_options_type_info = {
        ...
        {"comparator",
         OptionTypeInfo::AsCustomRawPtr<const Comparator>(
             ...
             rs::options_type::OptionVerificationType::ByName, OptionTypeFlags::kCompareLoose)
             .SetSerializeFunc(
        ...
        {"memtable_insert_with_hint_prefix_extractor",
         OptionTypeInfo::AsCustomSharedPtr<const SliceTransform>(
             offsetof(struct ImmutableCFOptions,
                      memtable_insert_with_hint_prefix_extractor),
             rs::options_type::OptionVerificationType::ByNameAllowNull, OptionTypeFlags::kNone)},
        {"memtable_factory",
        ...
        {"table_properties_collectors",
         OptionTypeInfo::Vector<
             ...
             rs::options_type::OptionVerificationType::ByName, OptionTypeFlags::kNone,
        ...
        {"compaction_filter",
         OptionTypeInfo::AsCustomRawPtr<const CompactionFilter>(
             ...
             rs::options_type::OptionVerificationType::ByName, OptionTypeFlags::kAllowNull)},
