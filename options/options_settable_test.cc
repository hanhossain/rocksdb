  ...
  *options = DBOptions();
  ...
  ASSERT_OK(
      GetDBOptionsFromString(config_options, *options,
                             ...
                             "wal_compression=CompressionType::ZSTD;"
                             "seq_per_batch=false;"
                             "atomic_flush=false;"
...
TEST_F(OptionsSettableTest, ColumnFamilyOptionsAllFieldsSettable) {
  ...
  ASSERT_OK(GetColumnFamilyOptionsFromString(
      ...
      "compression_per_level=CompressionType::BZip2Compression:CompressionType::BZip2Compression:"
      "CompressionType::BZip2Compression:CompressionType::NoCompression:CompressionType::ZlibCompression:CompressionType::BZip2Compression:"
      ...
      "blob_compression_type=CompressionType::BZip2Compression;"
